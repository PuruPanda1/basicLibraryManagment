	...
	public static void admin_menu() {
	    ...
	    create_but.addActionListener(new ActionListener() { //Perform action
	        public void actionPerformed(ActionEvent e){
	            ...
	            com.system.CreateDatabase.create();//Call create function
	    ...
	    view_but.addActionListener(new ActionListener() {
	        public void actionPerformed(ActionEvent e){
	            ...
	            Connection connection = com.system.Connection.connect(); //connect to database
	    ...
	    users_but.addActionListener(new ActionListener() { //Perform action on click button
	        public void actionPerformed(ActionEvent e){
	                ...
	                Connection connection = com.system.Connection.connect();
...
//	                create a jlist here for the book
	                JTextField F_bid = new JTextField();
	                F_bid.setBounds(110, 15, 200, 30);
	                 
//	                 create jlist here for the user
	        ...
	        public void actionPerformed(ActionEvent e){
	                ...
	                create_but.addActionListener(new ActionListener() {
	                    ...
	                    Statement stmt = connection.createStatement();
	                     ...
	                     Connection connection1 = com.system.Connection.connect();
