	...
	public static void login() {
	    ...
	    login_but.addActionListener(new ActionListener() {  //Perform action
	        ...
	        else if(password.equals("")) //If password is null
	        {
	            ...
	            Connection connection=com.system.Connection.connect();  //Connect to the database
	            try
	            {
	                ...
	                if(rs.next()==false) { //Move pointer below
	                  ...
	                  if(admin.equals("1")) { //If boolean value 1
	                      com.system.Admin.admin_menu(); //redirect to admin menu
	                  }
	                  else{
	                      com.system.User.user_menu(UID); //redirect to user menu for that user ID
	                  }
	              }
	            }
	            catch (Exception ex) {
